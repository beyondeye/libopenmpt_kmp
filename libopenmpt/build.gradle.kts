...
// Debug libraries are stored in a separate directory to avoid conflicts with release builds.
...
// Release libraries go to the main jniLibs directory, which is used for publishing.
