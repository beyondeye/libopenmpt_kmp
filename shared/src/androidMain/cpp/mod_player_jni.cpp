...
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeCreate(
...
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeDestroy(
...
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeLoadModule(
...
JNIEXPORT jboolean JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeLoadModuleFromPath(
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeUnloadModule(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (engine) {
        engine->unloadModule();
...
JNIEXPORT jboolean JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativePlay(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) {
        LOGE("Invalid engine handle");
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativePause(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (engine) {
        engine->pause();
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeStop(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (engine) {
        engine->stop();
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeSeek(
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeSetRepeatCount(
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeSetMasterGain(
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeSetStereoSeparation(
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeSetTempoFactor(
...
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetTempoFactor(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
...
JNIEXPORT void JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeSetPitchFactor(
        JNIEnv* env, jobject thiz, jlong handle, jdouble factor) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (engine) {
...
JNIEXPORT jdouble JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetPitchFactor(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return 1.0;
...
JNIEXPORT jboolean JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeIsPlaying(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
...
JNIEXPORT jdouble JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetPositionSeconds(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
...
JNIEXPORT jdouble JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetDurationSeconds(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return 0.0;
...
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetMetadata(
...
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetCurrentOrder(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return -1;
...
JNIEXPORT jint JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetCurrentPattern(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return -1;
...
JNIEXPORT jint JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetCurrentRow(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return -1;
...
JNIEXPORT jint JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetNumChannels(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return 0;
...
JNIEXPORT jint JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetNumPatterns(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return 0;
...
JNIEXPORT jint JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetNumOrders(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return 0;
...
JNIEXPORT jint JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetNumInstruments(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return 0;
...
JNIEXPORT jint JNICALL
Java_com_beyondeye_openmpt_core_ModPlayerNative_nativeGetNumSamples(
        JNIEnv* env, jobject thiz, jlong handle) {
    ModPlayerEngine* engine = handle_to_engine(handle);
    if (!engine) return 0;
